...
QT_INIT_METAOBJECT const QMetaObject Remove::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_Remove.data,
    qt_meta_data_Remove,
    qt_static_metacall,
    nullptr,
    nullptr
